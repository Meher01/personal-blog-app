...
const BlogList = () => {
  ...
  return (
    <div className='relative overflow-hidden rounded-[24px] border border-pink-200/400 shadow-lg shadow-pink-200/50 bg-gradient-to-b from-pink-100 to-purple-200 mb-12 ml-50 mr-50'>
