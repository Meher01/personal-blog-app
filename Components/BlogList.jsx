...
const BlogList = () => {
  ...
  return (
    <div className='relative overflow-hidden rounded-[24px] border border-pink-200/400 shadow-lg shadow-pink-200/50 bg-gradient-to-b from-pink-100 to-purple-200 mb-12 ml-30 mr-30'>
      <div className='flex justify-center gap-8 my-10 text-sm sm:text-base font-semibold' style={{fontSize: '18px'}}>
        ...
        <button onClick={()=>setMenu('Hobbies')} style={{cursor: 'pointer'}} className={menu==="Hobbies" ? 'bg-pink-500 text-white py-1 px-4 rounded-sm bold' : ""}>Hobbies</button>
      ...
      <div className='grid grid-cols-1 sm:grid-cols-3 lg:grid-cols-3 gap-6 p-6 mb-12 xl:mx-24'>
