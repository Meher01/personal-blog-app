  ...
  return (
    <div className='py-5 px-5 md:px-12 lg:px-28'>
      <div className='flex items-center justify-between'> 
        <Image src={assets.cam_light} width={110} height={50} alt='logo' className='w-[130px] sm:w-auto' /><p className='animated-text font-medium bold' style={{fontSize: '24px'}}>❤️Hi There, Welcome to my Blog❤️</p>
      ...
      <form className='flex justify-between max-w-[500px] scale-75 sm:scale-100 mx-auto mt-10 border border-black overflow-hidden' style={{ boxShadow: '0px 6px 6px rgba(241, 17, 129, 0.95)', borderRadius: '12px', cursor: 'pointer' }} action="">
        ...
        <button type='submit' className='bold border-l border-black py-4 px-4 sm:px-8 active:bg-pink-400 hover:text-white hover:bg-pink-400' style={{cursor: 'pointer'}}>Subscribe</button>
      </form>
      </div>
    </div>
  );
