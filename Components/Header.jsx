  ...
  return (
    <div className='relative z-10 py-5 px-5 md:px-12 lg:px-28'>
      ...
      <div className='text-center my-8'>
        ...
        <form onSubmit={onSubmitHandler} className='flex justify-start max-w-[500px] scale-75 sm:scale-100 mx-auto mt-10 border border-black overflow-hidden bg-white/70 backdrop-blur-sm' style={{ boxShadow: '0px 6px 6px rgba(241, 17, 129, 0.95)', borderRadius: '12px', cursor: 'pointer' }}>
